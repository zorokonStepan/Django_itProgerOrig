...
Глобальные настройки всего Django-проекта"""
...
# ALLOWED_HOSTS - доменные имена, на каторых можно опубликовать проект
ALLOWED_HOSTS = []


# Application definition
# INSTALLED_APPS - установленные приложения проекта
INSTALLED_APPS = [
...
# ROOT_URLCONF - основной файл urls
